...
def rotation(angle):
    ...
    c = math.cos(angle)
    s = math.sin(angle)
    return Mat(({'x','y','u'},{'x','y','u'}), {('x','x'):c, ('y','x'):s, ('x','y'):-1*s,('y','y'):c, ('u','u'):1})
...
def grayscale():
    ...
    '''
    return Mat(({'r','g','b'},{'r','g','b'}), {('r','r'):77/(256), ('r','g'): 151/(256), ('r','b'):28/(256), ('g','r'):77/(256), ('g','g'): 151/(256.0), ('g','b'):28/(256), ('b','r'):77/(256.0), ('b','g'): 151/(256.0), ('b','b'):28/(256)})
